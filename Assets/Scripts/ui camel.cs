...
public class uicamel : MonoBehaviour
{
    ...
    {
        if (other.CompareTag("Player")) // if player approaches the camel the ui image appears
        {
    ...
    {
        if (other.CompareTag("Player")) // if player leaves the camel area the ui image disappears 
        {
